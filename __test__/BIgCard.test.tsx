...
test('test the BigCard render', () => {
  const { image, artist, author, comment } = dataMocked;
  render(
    <BigCard image={image} artist={artist} author={author} comment={comment} />
  );
  ...
  expect(testImage.alt).toContain(
    'https://is2-ssl.mzstatic.com/image/thumb/Podcasts112/v4/cd/82/0c/cd820cfe-fce5-56aa-ef2c-da67576fd4b3/mza_3363134633883714623.jpeg/170x170bb.pn'
  );
});
